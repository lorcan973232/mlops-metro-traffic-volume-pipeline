...
def register_model(
    ...
    metadata = {
        ...
        "target_unit": metrics.get("target_unit"),
        ...
        "random_state": metrics.get("hyperparameters", {}).get("regressor", {}).get("random_state"),
        ...
        "residual_summary": metrics.get("residual_summary", {}),
        "model_path": str(model_path),
